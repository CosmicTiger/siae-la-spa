...
export class ApiService {
  ...
  post<T = any>(path: string, body: any) {
    return this.http.post<ApiResponse<T>>(this.url(path), body).pipe(map((r) => r.data ?? null));
  }

  put<T = any>(path: string, body: any) {
    return this.http.put<ApiResponse<T>>(this.url(path), body).pipe(map((r) => r.data ?? null));
  }

  patch<T = any>(path: string, body: any) {
    return this.http.patch<ApiResponse<T>>(this.url(path), body).pipe(map((r) => r.data ?? null));
  }
